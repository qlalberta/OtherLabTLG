...
class HomeOwnerLine : Policy, IPolicy, IHousingPolicy
{
    //need to work this
    ...
    public HomeOwnerLine
        (int parcelID, string propertyType, string postCode,
        int id, decimal propertyLimit,
        decimal liabilityLimit, string name, string polilcyStatus, 
    ...
    //override public string FindPolicy()
    //{
