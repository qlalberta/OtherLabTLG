...
class AutoLine : Policy, IPolicy, IVehiclePolicy
{
    private string vin;
    ...
    public AutoLine(string vin, string VehicleType,
        int id, decimal propertyLimit, decimal liabilityLimit, string name, string polilcyStatus, string startTime, string endTime)
     : base(id, propertyLimit, liabilityLimit, name, polilcyStatus, startTime, endTime)
    {

    }

    //may need to override the built-in string method and change the return type
